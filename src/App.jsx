            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setF("targetWeight", e.target.value)}
                  style={inp}
                />
              </div>
            </div>
        ...
        {bmi && (
          <Card title="BMI Estimate" icon="📊">
            <div style={{ textAlign: "center", padding: "8px 0" }}>
              ...
              >
                Based on latest weight · 172cm assumed
              </div>
            </div>
          </Card>
        )}
...
function MainApp({
  ...
  const panels = {
    ...
    weight: <WeightPanel />,
    health: <HealthPanel {...healthPanelProps} /> /*, ai: <AIPanel />*/,
  };
